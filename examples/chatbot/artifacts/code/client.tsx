...
const isPythonContent = (content: string) => {
  ...
  actions: [
    {
      ...
      onClick: async ({ content, setMetadata }) => {
        if (!isPythonContent(content)) {
          toast.error(
            "Run supports Python only. Use TON sandbox tools for Tolk/FunC/Tact."
          );
          return;
        }
        ...
        try {
          ...
          const currentPyodideInstance = await loader({
      ...
      isDisabled: ({ content }) => !isPythonContent(content),
    },
    {
